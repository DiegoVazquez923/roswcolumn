...
class _MyHomePageState extends State<MyHomePage> {
  ...
  child: Column(
    ...
    children: [
      ...
      const SizedBox(height: 10),
      // Nuevo bloque
      const Text('7) Datos de Usuario', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
      const SizedBox(height: 8),
      Container(
        padding: const EdgeInsets.all(12),
        color: Colors.grey.shade200,
          ...
          children: [
            Row(
              children: const [
                CircleAvatar(
                  radius: 20,
                  backgroundImage: NetworkImage('https://i.pinimg.com/236x/7b/14/17/7b14175c54c8bf5d193c20ed8578ebe3.jpg'),
                ),
                SizedBox(width: 12),
                Icon(Icons.person),
              ],
            ...
            const Text('Nombre: Diego Vázquez', style: TextStyle(fontSize: 16)),
            const SizedBox(height: 6),
            const Text('Correo: diego.vazquez@example.com', style: TextStyle(fontSize: 16)),
            const SizedBox(height: 6),
            const Text('Teléfono: +777 123 1234', style: TextStyle(fontSize: 16)),
          ],
        ),
      ),
    ],
